...
<nav class="sidebar-nav">
  ...
  <div class="sidebar-content">
    ...
    <ul class="nav nav-pills flex-column">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo ($currentPage === 'terrains') ? 'active' : ''; ?>" href="index.php?page=terrains">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo ($currentPage === 'reservations') ? 'active' : ''; ?>" href="index.php?page=reservations">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo ($currentPage === 'tournois') ? 'active' : ''; ?>" href="index.php?page=tournois">
