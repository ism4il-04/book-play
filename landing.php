...
<head>
  ...
  <link href="includes/landing/landing_style.css" rel="stylesheet">
</head>
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav align-items-center">
          ...
          <li class="nav-item"><a class="btn btn-green ms-lg-3" href="user/dashboard.php">Book a Field</a></li>
        </ul>
      </div>
    </div>
  </nav>
    ...
    <div class="container">
      <div class="row align-items-center gy-4">
        ...
        <div class="col-lg-6 text-center">
          <img src="assets/lionel-messi-soccer-hd-0qr05jpgiccfmtpz.jpg?v=<?= time() ?>" alt="People playing football">
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="contact">
    <div class="container">
      ...
      <form method="POST" action="" class="d-flex flex-column flex-sm-row justify-content-center align-items-center mt-4">
      ...
      <?php
        if (isset($_POST['subscribe'])) {
          ...
          echo "<p class='mt-3 bg-white text-success rounded-pill px-4 py-2 d-inline-block'>Thanks for subscribing, $email!</p>";
        }
      ?>
    </div>
  </section>
